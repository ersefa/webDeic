...
(function ($) {
    ...
    $.fn.pwi.defaults = {
        ...
        maxResults: 200, //-- photos per page
        showPager: 'top', //'top', 'bottom', 'both' (for both albums and album paging)
        thumbSize: 120,  //-- specify thumbnail size of photos (default: 72, cropped not supported, supported cropped/uncropped: 32, 48, 64, 160 and uncropped only: 72, 144, 200, 288, 320, 400, 512, 576, 640, 720, 800) 
		...
		labels: {
            photo: "foto",
            photos: "fotos",
            albums: "Volver a álbumes",
            slideshow: "Mostrar slideshow",
            loading: "PWI recabando datos...",
            page: "Pagina",
            prev: "Anterior",
            next: "Siguiente",
            devider: "|"
